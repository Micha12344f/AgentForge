...
def refresh_link_tracking_stats() -> int:
    ...
    try:
        ...
        for ar in attr_rows:
            ...
            if camp:
                conversion_counts[camp] = conversion_counts.get(camp, 0) + 1
        ...
        for row in rows:
            ...
            try:
                ...
                real_conversions = conversion_counts.get(campaign, 0)
    ...
    for page in all_seq_pages:
        ...
        try:
            resp = notion_request(
                ...
                headers=h, json={"properties": update_props}, timeout=15,
            )
