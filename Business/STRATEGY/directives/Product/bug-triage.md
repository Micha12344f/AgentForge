...
|---|---|---|
| Bug Issue | GitHub Issue with severity, labels, full diagnostics | hedge-edge-app repo, local app path: `Business/STRATEGY/resources/Product/Hedge-Edge-App/Hedge-Edge-Beta/Hedge-Edge-Front-end` |
