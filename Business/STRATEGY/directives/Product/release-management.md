...
- GitHub remote: `https://github.com/Micha12344f/Hedge-Edge-App`
...
4. Landing page /changelog route on Vercel (deployed via `npx vercel --prod`, not GitHub auto-deploy)
...
- Vercel (VERCEL_TOKEN): Query deployment status. Landing page deploys are CLI-based (`npx vercel --prod` from landing page repo at `Context/IB agreement/Hedge-Edge-Landing-Page`)
