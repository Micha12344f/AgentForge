...
| Regression Test | Test code with linked GitHub Issue | hedge-edge-app repo test directory, local app path: `Business/STRATEGY/resources/Product/Hedge-Edge-App/Hedge-Edge-Beta/Hedge-Edge-Front-end` |
