...
| Platform PR Requirements | GitHub Issue with acceptance criteria for platform PRs | hedge-edge-app repo, local app path: `Business/STRATEGY/resources/Product/Hedge-Edge-App/Hedge-Edge-Beta/Hedge-Edge-Front-end` |
