...
- Create a parent Epic issue in the hedge-edge-app repository
  Local app path: `Business/STRATEGY/resources/Product/Hedge-Edge-App/Hedge-Edge-Beta/Hedge-Edge-Front-end`
...
| **GitHub Issues** | Issue with labels, assignees, acceptance criteria | hedge-edge-app repo, local app path: `Business/STRATEGY/resources/Product/Hedge-Edge-App/Hedge-Edge-Beta/Hedge-Edge-Front-end` |
